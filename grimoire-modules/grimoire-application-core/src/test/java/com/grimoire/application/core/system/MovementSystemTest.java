...
class MovementSystemTest {
    ...
    void entityMovesWithVelocity() {
        ...
        Position pos = world.getComponent(entity, Position.class).orElseThrow();
    ...
    void collisionStopsEntity() {
        ...
        String obstacle = world.createEntity();
        ...
        String mover = world.createEntity();
        ...
        Velocity vel = world.getComponent(mover, Velocity.class).orElseThrow();
    ...
    void entityWithoutBoundingBoxDoesNotCollide() {
        ...
        Position pos = world.getComponent(mover, Position.class).orElseThrow();
        assertThat(pos.x()).isCloseTo(10.0, within(0.01));
    }
    ...
    void multipleEntitiesMoveIndependently() {
        ...
        Position p1 = world.getComponent(e1, Position.class).orElseThrow();
        Position p2 = world.getComponent(e2, Position.class).orElseThrow();
